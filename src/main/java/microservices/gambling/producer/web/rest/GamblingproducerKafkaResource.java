...
@RestController
@RequestMapping("/api/gamblingproducer-kafka")
public class GamblingproducerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GamblingproducerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GamblingproducerKafkaResource(KafkaProperties kafkaProperties) {
